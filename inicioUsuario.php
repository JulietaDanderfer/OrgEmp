...
<body>
    ...
    <main>
        ...
        <div class="container__box">
            <a href="inicioRegistrarMascotaUsuario.php" style="text-decoration: none;">
                <div class="box">
            ...
            <div class="box">
                ...
                <h5>Ver mis Mascotas</h5>
                <h4>Ver mis Mascotas</h4>
            </div>
            <div class="box">
                <i class="lni lni-arrow-right-circle"></i>
                <h5>Transferir Mascota</h5>
                <h4>Transferir Mascota</h4>
            </div>
            <div class="box">
                <i class="lni lni-calendar"></i>
                <h5>calendario de vacunacion</h5>
                <h4>calendario de vacunacion</h4>
            </div>
